      ...
      <Header />
        ...
        <div className="flex flex-col content-center items-center h-screen">
          ...
          <div className="m-auto relative">
            ...
            <h2 className="absolute font-ibmplex font-bold text-sm text-white text-center w-full">Meet</h2>
            <br />
            <h1 className="text-9xl font-blackout md:text-12xl font-normal">mUbeeN</h1>

            <h2 className="absolute font-ibmplex font-bold text-sm text-white text-center w-full">Graphic Designer and Web Developer</h2>

          </div>

          <div className="w-fit h-full absolute flex flex-col items-center ">

            <p className="text-center w-4/5 m-auto text-white font-normal translate-y-44 text-xxm">
